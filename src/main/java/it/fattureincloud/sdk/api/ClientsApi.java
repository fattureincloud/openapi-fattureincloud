...
public class ClientsApi {
    ...
    String localVarPath =
        "/c/{company_id}/entities/clients/{client_id}"
            .replaceAll(
                "\\{" + "company_id" + "\\}", localVarApiClient.escapeString(companyId.toString()))
            .replaceAll(
                "\\{" + "client_id" + "\\}", localVarApiClient.escapeString(clientId.toString()));
  ...
  private okhttp3.Call listClientsValidateBeforeCall(
    ...
    okhttp3.Call localVarCall =
        listClientsCall(companyId, fields, fieldset, sort, page, perPage, q, _callback);
    return localVarCall;
  }
  ...
  private okhttp3.Call modifyClientValidateBeforeCall(
    ...
    okhttp3.Call localVarCall =
        modifyClientCall(companyId, clientId, modifyClientRequest, _callback);
    return localVarCall;
  }
