...
public class IssuedDocument implements Serializable {
  ...
  public enum EiStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<EiStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final EiStatusEnum enumeration) throws IOException {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Number of the document [If not specified, next number is used]")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/A", value = "Numeration of the document [Not available if type=delivery_note]")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[Can be set only if global_cassa_taxable is NULL] Global cassa taxable amount")
  ...
  **/
  ...
  public IssuedDocument amountOtherWithholdingTaxTaxable(BigDecimal amountOtherWithholdingTaxTaxable) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[Read Only] Public url of the attached file. Authomatically set if a valid attachment token is passed via POST /issued_documents or PUT /issued_documents/{documentId}.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[Write Only] Attachment token returned by POST /issued_documents/attachment. Used to attach the file already uploaded.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[Read only] Status of the e-invoice.   * `attempt` - We are trying to send the invoice, please wait up to 2 hours   * `missing` - The invoice is missing   * `not_sent` - The invoice has yet to be sent   * `sent` - The invoice was sent   * `pending` - The checks for the digital signature and sending are in progress   * `processing` - The SDI is delivering the invoice to the customer   * `error` - An error occurred while handling the invoice, please try to resend it or contact support   * `discarded` - The invoice has been rejected by the SDI, so it must be corrected and re-sent   * `not_delivered` - The SDI was unable to deliver the invoice   * `accepted` - The customer accepted the invoice   * `rejected` - The customer rejected the invoice, so it must be corrected   * `no_response` - A response has not yet been received whithin the deadline, contact the customer to ascertain the status of the invoice ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issuedDocument.id) &&
        ...
        Objects.equals(this.eiOtherWithholdingTaxCausal, issuedDocument.eiOtherWithholdingTaxCausal) &&
        ...
        Objects.equals(this.amountWithholdingTaxTaxable, issuedDocument.amountWithholdingTaxTaxable) &&
        Objects.equals(this.amountOtherWithholdingTax, issuedDocument.amountOtherWithholdingTax) &&
        Objects.equals(this.amountOtherWithholdingTaxTaxable, issuedDocument.amountOtherWithholdingTaxTaxable) &&
  ...
  public String toString() {
    ...
    sb.append("    amountCassa2Taxable: ").append(toIndentedString(amountCassa2Taxable)).append("\n");
    sb.append("    globalCassaTaxable: ").append(toIndentedString(globalCassaTaxable)).append("\n");
    sb.append("    amountGlobalCassaTaxable: ").append(toIndentedString(amountGlobalCassaTaxable)).append("\n");
    sb.append("    withholdingTax: ").append(toIndentedString(withholdingTax)).append("\n");
    sb.append("    withholdingTaxTaxable: ").append(toIndentedString(withholdingTaxTaxable)).append("\n");
    sb.append("    otherWithholdingTax: ").append(toIndentedString(otherWithholdingTax)).append("\n");
    ...
    sb.append("    eiWithholdingTaxCausal: ").append(toIndentedString(eiWithholdingTaxCausal)).append("\n");
    sb.append("    eiOtherWithholdingTaxType: ").append(toIndentedString(eiOtherWithholdingTaxType)).append("\n");
    sb.append("    eiOtherWithholdingTaxCausal: ").append(toIndentedString(eiOtherWithholdingTaxCausal)).append("\n");
    ...
    sb.append("    deliveryNoteTemplate: ").append(toIndentedString(deliveryNoteTemplate)).append("\n");
    ...
    sb.append("    showNotificationButton: ").append(toIndentedString(showNotificationButton)).append("\n");
    ...
    sb.append("    amountRivalsaTaxable: ").append(toIndentedString(amountRivalsaTaxable)).append("\n");
    sb.append("    amountWithholdingTax: ").append(toIndentedString(amountWithholdingTax)).append("\n");
    sb.append("    amountWithholdingTaxTaxable: ").append(toIndentedString(amountWithholdingTaxTaxable)).append("\n");
    sb.append("    amountOtherWithholdingTax: ").append(toIndentedString(amountOtherWithholdingTax)).append("\n");
    sb.append("    amountOtherWithholdingTaxTaxable: ").append(toIndentedString(amountOtherWithholdingTaxTaxable)).append("\n");
    sb.append("    amountEnasarcoTaxable: ").append(toIndentedString(amountEnasarcoTaxable)).append("\n");
