...
public class ListTemplatesResponse implements Serializable {
  ...
  private List<DocumentTemplate> data = null;

  public ListTemplatesResponse() { 
  }

  public ListTemplatesResponse data(List<DocumentTemplate> data) {
    
    this.data = data;
    return this;
  }

  public ListTemplatesResponse addDataItem(DocumentTemplate dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listTemplatesResponse.data);
  }
