...
public class ListPaymentMethodsResponse implements Serializable {
  ...
  public ListPaymentMethodsResponse data(List<PaymentMethod> data) {
    
    this.data = data;
    return this;
  }

  public ListPaymentMethodsResponse addDataItem(PaymentMethod dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listPaymentMethodsResponse.data);
  }
