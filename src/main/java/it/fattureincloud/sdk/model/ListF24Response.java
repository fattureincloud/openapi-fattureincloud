...
import it.fattureincloud.sdk.model.ListF24ResponseAggregation;
...
public class ListF24Response implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data, aggregatedData);
  }
