...
public class EmailData implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "By default is the logged company email. This is the email address to which a copy will be sent.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If the document has one or more attachments, this flag will be set to true")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipientEmail, defaultSenderEmail, senderEmailsList, ccEmail, subject, body, documentExists, deliveryNoteExists, attachmentExists, accompanyingInvoiceExists, defaultAttachPdf);
  }
  ...
  public String toString() {
    ...
    sb.append("    accompanyingInvoiceExists: ").append(toIndentedString(accompanyingInvoiceExists)).append("\n");
