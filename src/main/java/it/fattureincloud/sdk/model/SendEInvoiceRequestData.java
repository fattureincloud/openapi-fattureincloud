...
public class SendEInvoiceRequestData implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Value of TipoCassa used (optional, override the company default value).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Value of CausalePagamento used (optional, override the company default value).")
  ...
  public String toString() {
    ...
    sb.append("    withholdingTaxCausal: ").append(toIndentedString(withholdingTaxCausal)).append("\n");
    sb.append("}");
    return sb.toString();
  }
