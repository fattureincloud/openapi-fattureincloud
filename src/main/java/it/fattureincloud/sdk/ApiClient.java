...
public class ApiClient {
    ...
    private String basePath = "https://api-v2.fattureincloud.it";
    ...
    private void init() {
        ...
        setUserAgent("FattureInCloud/0.0.0/Java-SDK");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-v2.fattureincloud.it
