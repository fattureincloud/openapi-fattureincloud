...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    public class GetCompanyInfoResponseTests : IDisposable
    {
        ...
        {
            Assert.IsType<CompanyInfo>(instance.Data);
        }
