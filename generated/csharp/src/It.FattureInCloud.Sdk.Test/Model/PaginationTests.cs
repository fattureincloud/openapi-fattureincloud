...
namespace It.FattureInCloud.Sdk.Test.Model
{
    ...
    public class PaginationTests : IDisposable
    {
        ...
        {
            var body = "{ 'current_page': 2, 'first_page_url': 'page=1', 'from': 1, 'last_page': 3, 'last_page_url': 'page=3', 'next_page_url': 'page=3', 'path': '/archive', 'per_page': 50, 'prev_page_url': 'page=1', 'to': 3, 'total': 155 }";
            instance = JsonConvert.DeserializeObject<Pagination>(body);
        }
