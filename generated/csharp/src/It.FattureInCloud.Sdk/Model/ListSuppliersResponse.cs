...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSuppliersResponse")]
    public partial class ListSuppliersResponse : IEquatable<ListSuppliersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSuppliersResponse" /> class.
        /// </summary>
        ...
        public ListSuppliersResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<Supplier> data = default)
        {
        ...
        {
            return this.Equals(input as ListSuppliersResponse);
        }

        /// <summary>
        /// Returns true if ListSuppliersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSuppliersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSuppliersResponse input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListSuppliersResponse" />
    /// </summary>
    public class ListSuppliersResponseJsonConverter : JsonConverter<ListSuppliersResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListSuppliersResponse" />
        /// </summary>
        ...
        public override ListSuppliersResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ListSuppliersResponse(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data);
        }

        /// <summary>
        /// Serializes a <see cref="ListSuppliersResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listSuppliersResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListSuppliersResponse listSuppliersResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listSuppliersResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListSuppliersResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listSuppliersResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListSuppliersResponse listSuppliersResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listSuppliersResponse.CurrentPageOption.IsSet)
                if (listSuppliersResponse.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", listSuppliersResponse.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (listSuppliersResponse.FirstPageUrlOption.IsSet)
                if (listSuppliersResponse.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", listSuppliersResponse.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (listSuppliersResponse.FromOption.IsSet)
                if (listSuppliersResponse.FromOption.Value != null)
                    writer.WriteNumber("from", listSuppliersResponse.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (listSuppliersResponse.LastPageOption.IsSet)
                if (listSuppliersResponse.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", listSuppliersResponse.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (listSuppliersResponse.LastPageUrlOption.IsSet)
                if (listSuppliersResponse.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", listSuppliersResponse.LastPageUrl);
                else
                    writer.WriteNull("last_page_url");

            if (listSuppliersResponse.NextPageUrlOption.IsSet)
                if (listSuppliersResponse.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", listSuppliersResponse.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (listSuppliersResponse.PathOption.IsSet)
                if (listSuppliersResponse.PathOption.Value != null)
                    writer.WriteString("path", listSuppliersResponse.Path);
                else
                    writer.WriteNull("path");

            if (listSuppliersResponse.PerPageOption.IsSet)
                if (listSuppliersResponse.PerPageOption.Value != null)
                    writer.WriteNumber("per_page", listSuppliersResponse.PerPageOption.Value!.Value);
                else
                    writer.WriteNull("per_page");

            if (listSuppliersResponse.PrevPageUrlOption.IsSet)
                if (listSuppliersResponse.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", listSuppliersResponse.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (listSuppliersResponse.ToOption.IsSet)
                if (listSuppliersResponse.ToOption.Value != null)
                    writer.WriteNumber("to", listSuppliersResponse.ToOption.Value!.Value);
                else
                    writer.WriteNull("to");

            if (listSuppliersResponse.TotalOption.IsSet)
                if (listSuppliersResponse.TotalOption.Value != null)
                    writer.WriteNumber("total", listSuppliersResponse.TotalOption.Value!.Value);
                else
                    writer.WriteNull("total");

            if (listSuppliersResponse.DataOption.IsSet)
                if (listSuppliersResponse.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, listSuppliersResponse.Data, jsonSerializerOptions);
                }
                else
