...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListF24Response : IEquatable<ListF24Response>, IValidatableObject
    {
        ...
        public ListF24Response(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<F24> data = default, ListF24ResponseAggregatedData aggregatedData = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListF24Response" />
    /// </summary>
    public class ListF24ResponseJsonConverter : JsonConverter<ListF24Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListF24Response" />
        /// </summary>
        ...
        public override ListF24Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (aggregatedData.IsSet && aggregatedData.Value == null)
                throw new ArgumentNullException(nameof(aggregatedData), "Property is not nullable for class ListF24Response.");

            return new ListF24Response(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data, aggregatedData);
        }

        /// <summary>
        /// Serializes a <see cref="ListF24Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listF24Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListF24Response listF24Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listF24Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListF24Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listF24Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListF24Response listF24Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listF24Response.AggregatedDataOption.IsSet && listF24Response.AggregatedData == null)
                throw new ArgumentNullException(nameof(listF24Response.AggregatedData), "Property is required for class ListF24Response.");

            if (listF24Response.CurrentPageOption.IsSet)
                if (listF24Response.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", listF24Response.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (listF24Response.FirstPageUrlOption.IsSet)
                if (listF24Response.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", listF24Response.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (listF24Response.FromOption.IsSet)
                if (listF24Response.FromOption.Value != null)
                    writer.WriteNumber("from", listF24Response.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (listF24Response.LastPageOption.IsSet)
                if (listF24Response.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", listF24Response.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (listF24Response.LastPageUrlOption.IsSet)
                if (listF24Response.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", listF24Response.LastPageUrl);
                else
                    writer.WriteNull("last_page_url");

            if (listF24Response.NextPageUrlOption.IsSet)
                if (listF24Response.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", listF24Response.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (listF24Response.PathOption.IsSet)
                if (listF24Response.PathOption.Value != null)
                    writer.WriteString("path", listF24Response.Path);
                else
                    writer.WriteNull("path");

            if (listF24Response.PerPageOption.IsSet)
                if (listF24Response.PerPageOption.Value != null)
                    writer.WriteNumber("per_page", listF24Response.PerPageOption.Value!.Value);
                else
                    writer.WriteNull("per_page");

            if (listF24Response.PrevPageUrlOption.IsSet)
                if (listF24Response.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", listF24Response.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (listF24Response.ToOption.IsSet)
                if (listF24Response.ToOption.Value != null)
                    writer.WriteNumber("to", listF24Response.ToOption.Value!.Value);
                else
                    writer.WriteNull("to");

            if (listF24Response.TotalOption.IsSet)
                if (listF24Response.TotalOption.Value != null)
                    writer.WriteNumber("total", listF24Response.TotalOption.Value!.Value);
                else
                    writer.WriteNull("total");

            if (listF24Response.DataOption.IsSet)
                if (listF24Response.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, listF24Response.Data, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("data");
            if (listF24Response.AggregatedDataOption.IsSet)
            {
                writer.WritePropertyName("aggregated_data");
                JsonSerializer.Serialize(writer, listF24Response.AggregatedData, jsonSerializerOptions);
            }
        }
    }
}
