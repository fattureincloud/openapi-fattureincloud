...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Pagination : IEquatable<Pagination>, IValidatableObject
    {
        ...
        public Pagination(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default)
        {
    ...
    public class PaginationJsonConverter : JsonConverter<Pagination>
    {
        ...
        public override Pagination Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Pagination(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Pagination pagination, JsonSerializerOptions jsonSerializerOptions)
        {
            if (pagination.CurrentPageOption.IsSet)
                if (pagination.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", pagination.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (pagination.FirstPageUrlOption.IsSet)
                if (pagination.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", pagination.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (pagination.FromOption.IsSet)
                if (pagination.FromOption.Value != null)
                    writer.WriteNumber("from", pagination.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (pagination.LastPageOption.IsSet)
                if (pagination.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", pagination.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (pagination.LastPageUrlOption.IsSet)
                if (pagination.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", pagination.LastPageUrl);
                else
            ...
            if (pagination.PathOption.IsSet)
                if (pagination.PathOption.Value != null)
                    writer.WriteString("path", pagination.Path);
                else
                    writer.WriteNull("path");

            if (pagination.PerPageOption.IsSet)
                if (pagination.PerPageOption.Value != null)
