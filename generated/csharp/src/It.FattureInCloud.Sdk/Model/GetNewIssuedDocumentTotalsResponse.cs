...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetNewIssuedDocumentTotalsResponse")]
    public partial class GetNewIssuedDocumentTotalsResponse : IEquatable<GetNewIssuedDocumentTotalsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNewIssuedDocumentTotalsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public GetNewIssuedDocumentTotalsResponse(IssuedDocumentTotals data = default)
        {
            this._Data = data;
            if (this.Data != null)
            {
        ...
        {
            return this.Equals(input as GetNewIssuedDocumentTotalsResponse);
        }

        /// <summary>
        /// Returns true if GetNewIssuedDocumentTotalsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetNewIssuedDocumentTotalsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetNewIssuedDocumentTotalsResponse input)
        {
            if (input == null)
            {
                return false;
