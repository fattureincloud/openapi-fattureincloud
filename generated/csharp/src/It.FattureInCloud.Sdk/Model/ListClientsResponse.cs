...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListClientsResponse : IEquatable<ListClientsResponse>, IValidatableObject
    {
        ...
        public ListClientsResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<ModelClient> data = default)
        {
