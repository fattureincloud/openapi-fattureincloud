...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListReceivedDocumentsResponse")]
    public partial class ListReceivedDocumentsResponse : IEquatable<ListReceivedDocumentsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ListReceivedDocumentsResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<ReceivedDocument> data = default)
        {
        ...
        {
            return this.Equals(input as ListReceivedDocumentsResponse);
        }

        /// <summary>
        /// Returns true if ListReceivedDocumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListReceivedDocumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListReceivedDocumentsResponse input)
        {
            if (input == null)
            {
                return false;
