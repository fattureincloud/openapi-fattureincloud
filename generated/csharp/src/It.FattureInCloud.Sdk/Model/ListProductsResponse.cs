...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListProductsResponse : IEquatable<ListProductsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ListProductsResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<Product> data = default)
        {
        ...
        /// <summary>
        /// Returns true if ListProductsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListProductsResponse to be compared</param>
        /// <returns>Boolean</returns>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListProductsResponse" />
    /// </summary>
    public class ListProductsResponseJsonConverter : JsonConverter<ListProductsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListProductsResponse" />
        /// </summary>
        ...
        public override ListProductsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Product>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "total":
                            ...
                            break;
                        case "data":
                            data = new Option<List<Product>?>(JsonSerializer.Deserialize<List<Product>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            return new ListProductsResponse(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data);
        }

        /// <summary>
        /// Serializes a <see cref="ListProductsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listProductsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListProductsResponse listProductsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listProductsResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListProductsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listProductsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListProductsResponse listProductsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listProductsResponse.CurrentPageOption.IsSet)
                if (listProductsResponse.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", listProductsResponse.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (listProductsResponse.FirstPageUrlOption.IsSet)
                if (listProductsResponse.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", listProductsResponse.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (listProductsResponse.FromOption.IsSet)
                if (listProductsResponse.FromOption.Value != null)
                    writer.WriteNumber("from", listProductsResponse.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (listProductsResponse.LastPageOption.IsSet)
                if (listProductsResponse.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", listProductsResponse.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (listProductsResponse.LastPageUrlOption.IsSet)
                if (listProductsResponse.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", listProductsResponse.LastPageUrl);
                else
                    writer.WriteNull("last_page_url");

            if (listProductsResponse.NextPageUrlOption.IsSet)
                if (listProductsResponse.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", listProductsResponse.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (listProductsResponse.PathOption.IsSet)
                if (listProductsResponse.PathOption.Value != null)
                    writer.WriteString("path", listProductsResponse.Path);
                else
                    writer.WriteNull("path");

            if (listProductsResponse.PerPageOption.IsSet)
                if (listProductsResponse.PerPageOption.Value != null)
                    writer.WriteNumber("per_page", listProductsResponse.PerPageOption.Value!.Value);
                else
                    writer.WriteNull("per_page");

            if (listProductsResponse.PrevPageUrlOption.IsSet)
                if (listProductsResponse.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", listProductsResponse.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (listProductsResponse.ToOption.IsSet)
                if (listProductsResponse.ToOption.Value != null)
                    writer.WriteNumber("to", listProductsResponse.ToOption.Value!.Value);
                else
                    writer.WriteNull("to");

            if (listProductsResponse.TotalOption.IsSet)
                if (listProductsResponse.TotalOption.Value != null)
                    writer.WriteNumber("total", listProductsResponse.TotalOption.Value!.Value);
                else
                    writer.WriteNull("total");

            if (listProductsResponse.DataOption.IsSet)
                if (listProductsResponse.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, listProductsResponse.Data, jsonSerializerOptions);
                }
                else
