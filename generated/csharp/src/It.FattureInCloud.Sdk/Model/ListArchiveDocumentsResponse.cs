...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListArchiveDocumentsResponse : IEquatable<ListArchiveDocumentsResponse>, IValidatableObject
    {
        ...
        public ListArchiveDocumentsResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<ArchiveDocument> data = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListArchiveDocumentsResponse" />
    /// </summary>
    public class ListArchiveDocumentsResponseJsonConverter : JsonConverter<ListArchiveDocumentsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListArchiveDocumentsResponse" />
        /// </summary>
        ...
        public override ListArchiveDocumentsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ArchiveDocument>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "total":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ArchiveDocument>?>(JsonSerializer.Deserialize<List<ArchiveDocument>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            return new ListArchiveDocumentsResponse(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data);
        }

        /// <summary>
        /// Serializes a <see cref="ListArchiveDocumentsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listArchiveDocumentsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListArchiveDocumentsResponse listArchiveDocumentsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listArchiveDocumentsResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListArchiveDocumentsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listArchiveDocumentsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListArchiveDocumentsResponse listArchiveDocumentsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listArchiveDocumentsResponse.CurrentPageOption.IsSet)
                if (listArchiveDocumentsResponse.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", listArchiveDocumentsResponse.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (listArchiveDocumentsResponse.FirstPageUrlOption.IsSet)
                if (listArchiveDocumentsResponse.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", listArchiveDocumentsResponse.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (listArchiveDocumentsResponse.FromOption.IsSet)
                if (listArchiveDocumentsResponse.FromOption.Value != null)
                    writer.WriteNumber("from", listArchiveDocumentsResponse.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (listArchiveDocumentsResponse.LastPageOption.IsSet)
                if (listArchiveDocumentsResponse.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", listArchiveDocumentsResponse.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (listArchiveDocumentsResponse.LastPageUrlOption.IsSet)
                if (listArchiveDocumentsResponse.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", listArchiveDocumentsResponse.LastPageUrl);
                else
                    writer.WriteNull("last_page_url");

            if (listArchiveDocumentsResponse.NextPageUrlOption.IsSet)
                if (listArchiveDocumentsResponse.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", listArchiveDocumentsResponse.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (listArchiveDocumentsResponse.PathOption.IsSet)
                if (listArchiveDocumentsResponse.PathOption.Value != null)
                    writer.WriteString("path", listArchiveDocumentsResponse.Path);
                else
                    writer.WriteNull("path");

            if (listArchiveDocumentsResponse.PerPageOption.IsSet)
                if (listArchiveDocumentsResponse.PerPageOption.Value != null)
                    writer.WriteNumber("per_page", listArchiveDocumentsResponse.PerPageOption.Value!.Value);
                else
                    writer.WriteNull("per_page");

            if (listArchiveDocumentsResponse.PrevPageUrlOption.IsSet)
                if (listArchiveDocumentsResponse.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", listArchiveDocumentsResponse.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (listArchiveDocumentsResponse.ToOption.IsSet)
                if (listArchiveDocumentsResponse.ToOption.Value != null)
                    writer.WriteNumber("to", listArchiveDocumentsResponse.ToOption.Value!.Value);
                else
                    writer.WriteNull("to");

            if (listArchiveDocumentsResponse.TotalOption.IsSet)
                if (listArchiveDocumentsResponse.TotalOption.Value != null)
                    writer.WriteNumber("total", listArchiveDocumentsResponse.TotalOption.Value!.Value);
                else
                    writer.WriteNull("total");

            if (listArchiveDocumentsResponse.DataOption.IsSet)
                if (listArchiveDocumentsResponse.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, listArchiveDocumentsResponse.Data, jsonSerializerOptions);
                }
                else
