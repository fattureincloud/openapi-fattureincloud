...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class ListEmailsResponse : IEquatable<ListEmailsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ListEmailsResponse(int currentPage = default, string firstPageUrl = default, int from = default, int lastPage = default, string lastPageUrl = default, string nextPageUrl = default, string path = default, int perPage = default, string prevPageUrl = default, int to = default, int total = default, List<Email> data = default)
        {
        ...
        {
            return this.Equals(input as ListEmailsResponse);
        }

        /// <summary>
        /// Returns true if ListEmailsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListEmailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListEmailsResponse input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListEmailsResponse" />
    /// </summary>
    public class ListEmailsResponseJsonConverter : JsonConverter<ListEmailsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="ListEmailsResponse" />
        /// </summary>
        ...
        public override ListEmailsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Email>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "total":
                            ...
                            break;
                        case "data":
                            data = new Option<List<Email>?>(JsonSerializer.Deserialize<List<Email>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ListEmailsResponse.");

            return new ListEmailsResponse(currentPage, firstPageUrl, from, lastPage, lastPageUrl, nextPageUrl, path, perPage, prevPageUrl, to, total, data);
        }

        /// <summary>
        /// Serializes a <see cref="ListEmailsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listEmailsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListEmailsResponse listEmailsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listEmailsResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListEmailsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listEmailsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListEmailsResponse listEmailsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listEmailsResponse.DataOption.IsSet && listEmailsResponse.Data == null)
                throw new ArgumentNullException(nameof(listEmailsResponse.Data), "Property is required for class ListEmailsResponse.");

            if (listEmailsResponse.CurrentPageOption.IsSet)
                if (listEmailsResponse.CurrentPageOption.Value != null)
                    writer.WriteNumber("current_page", listEmailsResponse.CurrentPageOption.Value!.Value);
                else
                    writer.WriteNull("current_page");

            if (listEmailsResponse.FirstPageUrlOption.IsSet)
                if (listEmailsResponse.FirstPageUrlOption.Value != null)
                    writer.WriteString("first_page_url", listEmailsResponse.FirstPageUrl);
                else
                    writer.WriteNull("first_page_url");

            if (listEmailsResponse.FromOption.IsSet)
                if (listEmailsResponse.FromOption.Value != null)
                    writer.WriteNumber("from", listEmailsResponse.FromOption.Value!.Value);
                else
                    writer.WriteNull("from");

            if (listEmailsResponse.LastPageOption.IsSet)
                if (listEmailsResponse.LastPageOption.Value != null)
                    writer.WriteNumber("last_page", listEmailsResponse.LastPageOption.Value!.Value);
                else
                    writer.WriteNull("last_page");

            if (listEmailsResponse.LastPageUrlOption.IsSet)
                if (listEmailsResponse.LastPageUrlOption.Value != null)
                    writer.WriteString("last_page_url", listEmailsResponse.LastPageUrl);
                else
                    writer.WriteNull("last_page_url");

            if (listEmailsResponse.NextPageUrlOption.IsSet)
                if (listEmailsResponse.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", listEmailsResponse.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (listEmailsResponse.PathOption.IsSet)
                if (listEmailsResponse.PathOption.Value != null)
                    writer.WriteString("path", listEmailsResponse.Path);
                else
                    writer.WriteNull("path");

            if (listEmailsResponse.PerPageOption.IsSet)
                if (listEmailsResponse.PerPageOption.Value != null)
                    writer.WriteNumber("per_page", listEmailsResponse.PerPageOption.Value!.Value);
                else
                    writer.WriteNull("per_page");

            if (listEmailsResponse.PrevPageUrlOption.IsSet)
                if (listEmailsResponse.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", listEmailsResponse.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (listEmailsResponse.ToOption.IsSet)
                if (listEmailsResponse.ToOption.Value != null)
                    writer.WriteNumber("to", listEmailsResponse.ToOption.Value!.Value);
                else
                    writer.WriteNull("to");

            if (listEmailsResponse.TotalOption.IsSet)
                if (listEmailsResponse.TotalOption.Value != null)
                    writer.WriteNumber("total", listEmailsResponse.TotalOption.Value!.Value);
                else
                    writer.WriteNull("total");

            if (listEmailsResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, listEmailsResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
