...
namespace It.FattureInCloud.Sdk.Model
{
    ...
    public partial class Company : IEquatable<Company>, IValidatableObject
    {
        ...
        public Company(int id = default, string name = default, CompanyType? type = default, string accessToken = default, List<ControlledCompany> controlledCompanies = default, DateOnly ficLicenseExpire = default, FattureInCloudPlanType? ficPlan = default, int connectionId = default, string taxCode = default, string vatNumber = default)
        {
            this._Id = id;
            if (this.Id != null)
            {
